...
import MapsScreen from "./src/components/Maps/Maps";
import SettingsScreen from "./src/components/Settings/Settings";
import DetailScreen from "./src/components/Details/Details";
import FavoritesScreen from "./src/components/Favorites/Favorites";
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "https://stud.hosted.hr.nl/1032518/Prog7/motorcycleStores.json"
      );
